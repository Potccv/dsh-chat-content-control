...
const typeRoots = [
  ...
  P('node_modules/.pnpm/@types+node@22.20.0/node_modules/@types'),
].filter(existsSync)
...
const paths = {
  ...
  '@deepseek-ai/dsh-client-ui-conversation/client': [P('packages/client/ui-conversation/lib/types/client/index.d.ts')],
  '@deepseek-ai/dsh-client-ui-settings/client': [P('packages/client/ui-settings/lib/types/client/index.d.ts')],
